...
def argparser_init():
   ...
   # Initialize subparser: noop
    ...
    for cmd in ['infer', 'draw', 'blur', 'noop']:
        ...
        group.add_argument('--measure_fps', dest='measure_fps', action='store_true', help='For stream inputs only, estimates the real framerate by measuring the time between each frame.')
