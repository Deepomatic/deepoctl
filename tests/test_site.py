...
class TestSite(object):
    def test_all(self):
        with setup() as manager:
            ...
            site = manager.create(name='site1', app_version_id=app_version_id, description='description')
            site_id = site['id']
            app_id = site['app']['id']
            ...
            site2 = manager.create(name='site2', app_version_id=app_version_id2, description='description')
            site_id2 = site2['id']
